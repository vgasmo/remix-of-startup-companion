...
const M = {
  title: { pt: 'Impacto Vitalício', en: 'Lifetime Impact' },
  titleTab: { pt: 'Impacto do Mentor', en: 'Mentor Impact' },
  mentor: { pt: 'Mentor', en: 'Mentor' },
  hoursLabel: { pt: 'Horas de Mentoria', en: 'Mentoring Hours' },
  sessionsLabel: { pt: 'Sessões', en: 'Sessions' },
  startupsLabel: { pt: 'Startups Apoiadas', en: 'Startups Supported' },
  startupsTitle: { pt: 'Startups que apoiaste', en: 'Startups you supported' },
  noStartups: { pt: 'Sem startups ainda.', en: 'No startups yet.' },
  avgRating: { pt: 'Avaliação média', en: 'Average rating' },
  ratings: { pt: 'avaliações', en: 'ratings' },
  testimonials: { pt: 'Testemunhos públicos', en: 'Public testimonials' },
  footer: { pt: 'Gerado por Startup Leiria', en: 'Generated by Startup Leiria' },
};
function tm(loc: Locale, k: keyof typeof M) { return pickLang(loc, M[k]); }

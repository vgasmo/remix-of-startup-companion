...
BEGIN
  BEGIN
    ...
    INSERT INTO public.programs(name) VALUES ('RC5-E Program') RETURNING id INTO v_program_id;
    INSERT INTO public.startups(name) VALUES ('RC5-E Startup') RETURNING id INTO v_startup_id;

    INSERT INTO public.workspaces(startup_id, program_id, status, created_by)
    VALUES (v_startup_id, v_program_id, 'active', founder_a)

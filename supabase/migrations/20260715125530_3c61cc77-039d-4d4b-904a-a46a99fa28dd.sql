...
AS $function$
  ...
  -- Normalize NULL last_activity_at to a deterministic sentinel so tuple
  -- comparison works reliably (NULLs in tuples yield NULL and were being
  -- silently dropped, and duplicates appeared when many rows shared the

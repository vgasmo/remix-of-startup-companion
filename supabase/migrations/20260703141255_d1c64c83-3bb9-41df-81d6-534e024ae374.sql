  ...
  BEGIN
    IF TG_OP = 'INSERT' THEN
      ...
      VALUES (
        ...
        '/mentors?tab=requests&connection=' || NEW.id::text,
      ...
      IF COALESCE(NEW.status, 'pending') = 'pending' THEN
        ...
        LOOP
          ...
          VALUES (
            ...
            '/mentors?mentor=' || NEW.mentor_id::text || '&connection=' || NEW.id::text,
    ...
    ELSIF TG_OP = 'UPDATE' AND NEW.status IS DISTINCT FROM OLD.status
      ...
      LOOP
        ...
        VALUES (
          ...
          '/mentors?mentor=' || NEW.mentor_id::text,
          jsonb_build_object('connection_id', NEW.id, 'mentor_id', NEW.mentor_id)
        );
      END LOOP;
    END IF;

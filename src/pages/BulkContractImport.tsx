                  ...
                  <ScrollArea className="h-48 border rounded-md p-2">
                    {files.map((f, i) => (
                      <div key={i} className="flex items-center justify-between py-1 text-sm">
                        ...
                        <Button variant="ghost" size="icon" onClick={() = aria-label={t('common.delete')}> removeFile(i)} aria-label={t('common.delete')}>
                          ...
                          <TableRow key={row.id} className={cn(row.status === 'error' && 'bg-destructive/5')}>
                            ...
                            <TableCell>
                              <div className="flex gap-1">
                                <Button variant="ghost" size="icon" onClick={() = aria-label={t('common.view')}> openPdfPreview(row)} aria-label={t('common.view')}>

          ...
          {stages?.map(stage => (
            <div key={stage.id} className="flex items-center gap-2 p-2 rounded bg-muted/30 group">
              ...
              <div className="opacity-0 group-hover:opacity-100 flex gap-1">
                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={()= aria-label="Edit"> handleEdit(stage)} aria-label={t('common.edit')}>
                  <Pencil className="h-3 w-3" />
                </Button>
                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={()= aria-label="Delete"> setDeleteTarget(stage)} aria-label={t('common.delete')}>
                ...
                <CardContent className="p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={()= aria-label="Edit"> handleEdit(program)} aria-label={t('common.edit')}>
                        <Pencil className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={()= aria-label="Delete"> setDeleteTarget(program)} aria-label={t('common.delete')}>

                  ...
                  <TableRow key={cat.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() = aria-label={t('common.edit')}> openCategoryDialog(cat)} aria-label={t('common.edit')}>
                          <Pencil className="h-3.5 w-3.5" />
                        </Button>
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() = aria-label={t('common.delete')}> openDeleteDialog('category', cat.id, cat.name)} aria-label={t('common.delete')}>
              ...
              <TableBody>
                {tags.map(tag => (
                  <TableRow key={tag.id}>
                    ...
                    <TableCell>
                      <div className="flex items-center gap-1">
                        <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() = aria-label={t('common.edit')}> openTagDialog(tag)} aria-label={t('common.edit')}>
                          <Pencil className="h-3.5 w-3.5" />
                        </Button>
                        <Button variant="ghost" size="icon" className="h-8 w-8 text-destructive" onClick={() = aria-label={t('common.delete')}> openDeleteDialog('tag', tag.id, tag.name)} aria-label={t('common.delete')}>
                          <Trash2 className="h-3.5 w-3.5" />
                        </Button>
                      </div>
                    </TableCell>

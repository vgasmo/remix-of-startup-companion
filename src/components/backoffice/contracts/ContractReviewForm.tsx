          ...
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormItem>
                ...
                <div className="h-10 flex items-center px-3 rounded-md border border-dashed border-border bg-muted/30 text-xs text-muted-foreground">
                  {t('contracts.numberAutoAssigned', {
                    defaultValue: 'Atribuído automaticamente ao guardar (INC-YYYY-NNN)',
                  })}
                </div>
              </FormItem>

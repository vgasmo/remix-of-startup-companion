...
const notificationTypeColors: Record<string, string> = {
  template_review: 'bg-[hsl(var(--info))]/10 text-[hsl(var(--info))]',
  session_reminder: 'bg-[hsl(var(--success))]/10 text-[hsl(var(--success))]',
  action_due: 'bg-[hsl(var(--warning))]/10 text-[hsl(var(--warning))]',
  mention: 'bg-primary/10 text-primary ',
  milestone_completed: 'bg-[hsl(var(--success))]/10 text-[hsl(var(--success))] ',
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  <Button
                    ...
                    onClick={(e)= aria-label="Delete"> handleDelete(e, notification.id)}

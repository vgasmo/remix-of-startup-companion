  ...
  const PaginationControls = () => (
    <div className="flex items-center justify-between px-4 py-3 border-t">
      ...
      <div className="flex items-center gap-1">
        ...
        <Button variant="outline" size="icon" className="h-8 w-8" disabled={page aria-label="Next">= totalPages - 1} onClick={() => setPage(p => p + 1)} aria-label={t('common.nextPage', { defaultValue: 'Next page' })}>
          <ChevronRight className="h-4 w-4" />
        </Button>
        <Button variant="outline" size="icon" className="h-8 w-8" disabled={page aria-label="Last">= totalPages - 1} onClick={() => setPage(totalPages - 1)} aria-label={t('common.lastPage', { defaultValue: 'Last page' })}>
              ...
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <Button
                    ...
                    onClick={(e)= aria-label="Open link"> { e.stopPropagation(); onRowClick(workspace.id); }}
                      ...
                      <div className="min-w-0">
                        <div className="flex items-center gap-2 min-w-0">
                          ...
                          <Button
                            ...
                            onClick={(e)= aria-label="Open link"> {
                              e.stopPropagation();

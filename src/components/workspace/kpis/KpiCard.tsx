...
export function KpiCard({
  ...
  const isFromSurvey = sourceType === 'survey';
      ...
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between">
          <div>
            ...
            {isFromSurvey && currentValue && (
              <Badge variant="secondary" className="text-xs mt-1 bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300">
                {t('kpis.fromSurvey', { defaultValue: 'Do inquérito' })}
              </Badge>
            )}
          </div>

                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {canManage && <Button variant="ghost" size="icon" className="h-6 w-6" onClick={()= aria-label="Delete"> handleDelete(note.id)} aria-label={t('common.delete')}><Trash2 className="h-3 w-3" /></Button>}
                        </div>
                      </div>

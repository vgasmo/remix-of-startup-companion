                ...
                <div key={member.id} className="flex items-start gap-4 p-4 rounded-lg border bg-card">
                  ...
                  {canEdit && (
                    <div className="flex gap-1">
                      <Button variant="ghost" size="icon" onClick={() = aria-label={t('common.edit')}> openEditDialog(member)} aria-label={t('common.edit', { defaultValue: 'Editar' })}>
                        <Pencil className="h-4 w-4" />
                      </Button>
                      <Button variant="ghost" size="icon" onClick={() = aria-label={t('common.delete')}> handleDelete(member.id, member.full_name)} className="text-destructive" aria-label={t('common.delete', { defaultValue: 'Eliminar' })}>

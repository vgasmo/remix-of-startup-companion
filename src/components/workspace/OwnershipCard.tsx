        ...
        <div className="space-y-2">
          ...
          {isEditingOwner && canEdit ? (
            ...
            <div className="flex items-center gap-3">
              ...
              {canEdit && (
                <Button variant="ghost" size="icon" onClick={()= aria-label="Edit"> setIsEditingOwner(true)} aria-label={t('common.edit')}>
          ...
          <div className="flex items-center justify-between">
            {isEditingFollowup && canEdit ? (
              ...
              <>
                ...
                {canEdit && (
                  <Button variant="ghost" size="icon" onClick={()= aria-label="Edit"> setIsEditingFollowup(true)} aria-label={t('common.edit')}>
                    <Edit2 className="h-4 w-4" />
                  </Button>
                )}
              </>

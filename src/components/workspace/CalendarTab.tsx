          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-1">
              <Button
                ...
                size="icon"
                className="h-8 w-8"
                onClick={() = aria-label={t('common.previous')}> setCurrentMonth(subMonths(currentMonth, 1))}
              ...
              <Button
                ...
                size="icon"
                className="h-8 w-8"
                onClick={() = aria-label={t('common.next')}> setCurrentMonth(addMonths(currentMonth, 1))}
                          ...
                          {canWrite && (
                            <div className="flex gap-1 shrink-0">
                              <Button
                                ...
                                onClick={() = aria-label={t('common.email')}> {
                              ...
                              <Button
                                ...
                                size="icon"
                                className="h-6 w-6"
                                onClick={() = aria-label={t('common.edit')}> openEditDialog(session)}
                              ...
                              <Button
                                ...
                                onClick={() = aria-label={t('common.delete')}> setDeleteConfirmId(session.id)}
